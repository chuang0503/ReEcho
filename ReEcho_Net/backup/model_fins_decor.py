...
class RIRDecoder_Decor(nn.Module):
    def __init__(self, input_dim=128,bp_kernel_size=1023, sr=16000, early_rir_duration=0.05, num_decay=20):
    ...
    def forward(self, rir_emb, seed, noise=None): # require B, C, T
...
def test_decor():
    ...
    seed = torch.randn(2, 128, 100)
    rir, late_reverb_freq, filtered_noise = rir_decoder(rir_emb, seed)
